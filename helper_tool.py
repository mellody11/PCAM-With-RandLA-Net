...
class ConfigS3DIS:
    ...
    num_points = 4096  # Number of input points     制作cam图，要改一下减少一个0
    ...
    sub_sampling_ratio = [2, 2, 2, 2, 1]  # sampling ratio of random sampling at each layer
    # sub_sampling_ratio = [4, 4]
    d_out = [16, 64, 128, 256, 512]  # feature dimension
    # d_out = [64, 64, 128, 256, 512]
